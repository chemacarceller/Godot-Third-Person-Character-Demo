...
static func _set_low_profile_vp(vp: Viewport) -> void :
	...
	MyLogger.info("FRAME : " + str(Engine.get_process_frames()) + " : " + "[ViewPort] Integrated or low VRAM ", "ConfigRender.gd", 158 , true)
...
static func _set_medium_profile_vp(vp: Viewport) -> void :
	...
	MyLogger.info("FRAME : " + str(Engine.get_process_frames()) + " : " + "[ViewPort] Medium (VRAM <= 4GB) ", "ConfigRender.gd", 193, true)
...
static func _set_high_profile_vp(vp: Viewport) -> void :
	...
	MyLogger.info("FRAME : " + str(Engine.get_process_frames()) + " : " + "[ViewPort] High (VRAM 6GB-8GB) ", "ConfigRender.gd", 222, true)
...
static func _set_ultra_profile_vp(vp: Viewport) -> void :
	...
	MyLogger.info("FRAME : " + str(Engine.get_process_frames()) + " : " + "[ViewPort] Full (VRAM > 8GB) ", "ConfigRender.gd", 250, true)
...
static func _set_low_profile_env(environment: Environment) -> void :
	...
	MyLogger.info("FRAME : " + str(Engine.get_process_frames()) + " : " + "[Render] Integrated or low VRAM. SDFGI: OFF ", "ConfigRender.gd", 268, true)
...
static func _set_medium_profile_env(environment: Environment) -> void :
	...
	MyLogger.info("FRAME : " + str(Engine.get_process_frames()) + " : " + "[Render] SDFGI Optimized (VRAM <= 4GB) ", "ConfigRender.gd", 291, true)
...
static func _set_high_profile_env(environment: Environment) -> void :
	...
	MyLogger.info("FRAME : " + str(Engine.get_process_frames()) + " : " + "[Render] SDFGI High (VRAM 6GB-8GB) ", "ConfigRender.gd", 311, true)
...
static func _set_ultra_profile_env(environment: Environment) -> void :
	...
	MyLogger.info("FRAME : " + str(Engine.get_process_frames()) + " : " + "[Render] SDFGI Full (VRAM > 8GB) ", "ConfigRender.gd", 331, true)
